...
- [下载 Windows x64 ZIP](https://github.com/yang-fu-physics/openlab-control/releases/download/v0.14.0/OpenLabControl-v0.14.0-windows-x64.zip)
- [下载 SHA-256 文件](https://github.com/yang-fu-physics/openlab-control/releases/download/v0.14.0/OpenLabControl-v0.14.0-windows-x64.zip.sha256)

在 PowerShell 中校验：

```powershell
Get-FileHash .\OpenLabControl-v0.14.0-windows-x64.zip -Algorithm SHA256
Get-Content .\OpenLabControl-v0.14.0-windows-x64.zip.sha256
```
