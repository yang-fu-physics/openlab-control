...
import random
import time
from ..models import InstrumentActivity, InstrumentKind, InstrumentSnapshot
...
class _SimulatedRampController(SystemInstrument):
    ...
    def __init__(self, config, simulation_speed: float = 1.0) -> None:
        ...
        self._activity = InstrumentActivity.DISCONNECTED
    ...
    async def connect(self) -> None:
        ...
        self._activity = InstrumentActivity.HOLDING
        self._last_poll = time.monotonic()
    ...
    async def poll(self) -> InstrumentSnapshot:
        ...
        if abs(difference) <= max_step or max_step == 0:
            ...
            self._activity = InstrumentActivity.MOVING
